...
# ==========================
# Nuevos modelos para sistema de solicitudes
# ==========================
...
class ItemSolicitudWeb(models.Model):
    ...
    # URL de destino cuando se haga clic en la publicidad
    ...
    # Formato solicitado (ej: 728x90) si se requiere especificarlo por item
    ...
    # Precio específico (puede variar del catálogo)
    ...
    def __str__(self):
        return f"Item Web #{self.id} - {self.ubicacion.nombre} (Solicitud #{self.solicitud.id})"
